...
void ObjectionWindow::setupUi() {
    ...
    switch (getCurrentLanguage()) {
    case 0: // 日语
        gifPath = ":/gifs1/objection/objection0.gif";
        break;
    case 1: // 英语
        gifPath = ":/gifs1/objection/objection1.gif";
        break;
    case 2: // 中文
        gifPath = ":/gifs1/objection/objection2.gif";
        break;
    default:
        gifPath = ":/gifs1/objection/objection0.gif"; // 默认日语
    }
